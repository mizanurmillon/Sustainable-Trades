...
class AllProductController extends Controller
{
    ...
    public function allProducts(Request $request) {
        ...
        $query = Product::with('images')->where('status', 'approved')->select('id','shop_info_id','product_name', 'product_price', 'product_quantity', 'unlimited_stock', 'out_of_stock', 'selling_option');
