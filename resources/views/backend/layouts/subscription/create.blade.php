                    ...
                    <div class="col-md-7">
                        <div class="card card-body">
                            ...
                            <div class="mt-4">
                                ...
                                <input type="file" name="image" id="image" class="dropify form-control @error('image') is-invalid @enderror" data-default-file="{{ asset('backend/images/placeholder/image_placeholder.png') }}">
                                @error('image')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
