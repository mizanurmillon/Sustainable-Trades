                            ...
                            <div class="row">
                                <div class="mt-4 col-md-6">
                                    ...
                                    <input type="file" name="icon" id="icon"
                                        ...
                                        data-default-file="{{ asset($data->icon ?? 'backend/images/placeholder/image_placeholder.png') }}">
                                    @error('icon')
                                ...
                                <div class="mt-4 col-md-6">
                                    ...
                                    <input type="file" name="page_image" id="image"
                                        ...
                                        data-default-file="{{ asset($data->page_image ?? 'backend/images/placeholder/image_placeholder.png') }}">
                                    @error('page_image')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
